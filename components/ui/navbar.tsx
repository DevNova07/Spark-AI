...
export function Navbar() {
  ...
  const logoElement = (
    <div className="relative w-6 h-6 flex items-center justify-center">
      ...
      <span className="absolute text-xs font-bold text-white">SI</span>
    </div>
  )
  ...
  const loginButtonElement = (
    <a
      href="tel:+919506724451"
      className="px-4 py-2 sm:px-3 text-xs sm:text-sm border border-[#333] bg-[rgba(31,31,31,0.62)] text-gray-300 rounded-full hover:border-white/50 hover:text-white transition-colors duration-200 w-full sm:w-auto text-center font-bold"
    >
      Call Us
    </a>
  )
