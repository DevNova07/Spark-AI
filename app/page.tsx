    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        <div className="container mx-auto px-4">
          <Card className="w-full h-[500px] bg-black/[0.96] relative overflow-hidden border-none text-left">
              ...
              <div className="flex-1 p-8 relative z-10 flex flex-col justify-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <a href="tel:+919506724451">Call 9506724451</a>
                  </Button>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-bold text-white text-left">Still Managing Everything Manually?</h2>
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-white text-left">We Build AI Solutions That Work</h3>
              <div className="space-y-4 text-gray-300">
                <p className="flex items-start gap-3">
      ...
      <section className="py-24 bg-black">
        <Pricing
          ...
          description="Flexible one-time pricing designed to scale with your business growth\nAll plans include setup, training, and 24/7 priority support"
          showToggle={false}
          plans={[
            {
              name: "Starter Plan",
              ...
              features: [
                ...
                "Basic workflow automation (up to 2 processes)",
                "Email integration",
                "Simple setup",
                "7-day support",
              ],
            ...
            },
            {
              ...
              period: "One-Time",
              features: [
                "AI Chatbot (advanced responses)",
                "Workflow automation (up to 3 processes)",
                "Email integration",
            ...
            },
            {
              ...
              period: "One-Time",
              features: [
                "Advanced AI Chatbot (custom logic)",
              ...
              description: "Complete AI automation solution",
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-white">SI Agency</h3>
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://wa.me/919506724451"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg text-gray-400 hover:text-white hover:bg-white/10 hover:border-green-500/50 transition-all duration-300 group"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-300">
                  ...
                  <a href="mailto:ramzaan0043@gmail.com" className="hover:text-white transition-colors duration-300">
                    ramzaan0043@gmail.com
                  </a>
                </div>
                ...
                <div className="flex items-center space-x-3 text-gray-300">
                  ...
                  <a href="tel:+919506724451" className="hover:text-white transition-colors duration-300">
                    9506724451
                  </a>
                </div>
          ...
          <div className="border-t border-white/10 mt-16 pt-8">
            <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
              <p className="text-gray-400 text-center lg:text-left">© 2026 SI Agency. All rights reserved.</p>
